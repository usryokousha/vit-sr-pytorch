...
_C.DATA.DATA_PATH = ''
# Path to label data, could be overwritten by command line argument
_C.DATA.LABEL_PATH = ''
# Validation ratio
_C.DATA.VAL_RATIO = 0.05
# Relative scale of inputs
_C.DATA.REL_SCALE = 4
# Dataset name
...
# [SimMIM] Model patch size for MaskGenerator
_C.DATA.MODEL_PATCH_SIZE = 2
# [SimMIM] Mask ratio for MaskGenerator
_C.DATA.MASK_RATIO = 0.06
...
# VAE parameters
_C.MODEL.VAE = CN()
_C.MODEL.VAE.IMAGE_SIZE = 256
_C.MODEL.VAE.NUM_LAYERS = 3
_C.MODEL.VAE.NUM_TOKENS = 8192
_C.MODEL.VAE.CHANNELS = 3
_C.MODEL.VAE.CODEBOOK_DIM = 512
_C.MODEL.VAE.HIDDEN_DIM = 256
_C.MODEL.VAE.NUM_RESNET_BLOCKS = 2
_C.MODEL.VAE.ENCODER_ONLY = False
...
# [SimMIM] path to pre-trained VAE
_C.VAE = ''
